...
export interface _SERVICE {
  ...
  'createProfile' : ActorMethod<[string, bigint, string, Sport], undefined>,
  'declineFriendRequest' : ActorMethod<[Principal], undefined>,
  'followUser' : ActorMethod<[Principal], undefined>,
  'getActivityLogsForCaller' : ActorMethod<[], Array<ActivityLog>>,
  ...
  'logActivity' : ActorMethod<[string, bigint, bigint, bigint], undefined>,
